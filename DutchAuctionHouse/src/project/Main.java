...
public class Main {
	public static void main(String arg[]){
		...
		try {
			...
			AgentController s1 = cc.createNewAgent("s1","agents.Shop", new Object[]{"pc",40,140});
			...
			AgentController c2 = cc.createNewAgent("c2","agents.Client", new Object[]{"pc",15,1000,140,1});
			AgentController c3 = cc.createNewAgent("c3","agents.Client", new Object[]{"pc",5,1000,155,1});
			AgentController c4 = cc.createNewAgent("c4","agents.Client", new Object[]{"pc",15,1000,150,1});
			AgentController c5 = cc.createNewAgent("c5","agents.Client", new Object[]{"pc",5,1000,150,1});
			AgentController c6 = cc.createNewAgent("c6","agents.Client", new Object[]{"pc",15,1000,145,2});
			AgentController c7 = cc.createNewAgent("c7","agents.Client", new Object[]{"pc",5,1000,155,2});
			AgentController c8 = cc.createNewAgent("c8","agents.Client", new Object[]{"pc",15,1000,150,2});
			AgentController c9 = cc.createNewAgent("c9","agents.Client", new Object[]{"pc",5,1000,130,2});
			AgentController c10 = cc.createNewAgent("c10","agents.Client", new Object[]{"pc",15,1000,150,2});
